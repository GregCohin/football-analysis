...
function ScoutingScreen({ matches }) {
  ...
  const rawSorted = [...enriched].sort((a, b) => (b.rawScore || -1) - (a.rawScore || -1));
  ...
  return (
    <div className="stats-screen">
      ...
      {scoutingSubTab === "comparaison" && (
        <>
          <p className="radar-note">Sélectionne 2 à 4 joueurs à comparer côte à côte (indépendamment du poste).</p>
          <div className="scouting-list">
            {enriched.map((p) => (
