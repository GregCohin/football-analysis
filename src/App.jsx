...
function emptyCauserie(name, opponent, date) {
  return {
    ...
    selectedPlayerIds: [], playerNotes: {}, sheets: [],
  };
}
...
function PrintableSheetsTab({ causerie, updateCauserie, roster }) {
    ...
    <div className="stats-screen">
      ...
      {!selected && (
        <div>
          ...
          <div className="roster-grid" style={{ marginTop: 16 }}>
            ...
            {[...causeries].sort((a, b) => new Date(b.date) - new Date(a.date)).map((c) => (
      ...
      {selected && (
        <div>
          ...
          {subTab === "fiches" && <PrintableSheetsTab causerie={selected} updateCauserie={updateCauserie} roster={roster} />}
        </div>
      )}
    </div>
  );
    ...
    <div className="stats-screen">
      ...
      {selected && (
        <div style={{ marginTop: 16 }}>
          ...
          <NextMatchCard fixtures={selected.fixtures} />
