...
import { Play, Pause, ArrowLeft, X, Download, Video as VideoIcon, Film, Menu, Home, Target, Users, Trophy, BarChart, ClipboardList, FileText, Eye, Search, Activity, Megaphone } from "lucide-react";
...
const CLIPS_DB_NAME = "tf_videotheque";
const CLIPS_STORE = "clips";

function openClipsDB() {
  return new Promise((resolve, reject) => {
    const req = indexedDB.open(CLIPS_DB_NAME, 1);
    req.onupgradeneeded = () => {
      const db = req.result;
...
const MATCHES_DB_NAME = "tf_matches_db";
...
function openMatchesDB() {
  return new Promise((resolve, reject) => {
    const req = indexedDB.open(MATCHES_DB_NAME, 2);
    req.onupgradeneeded = () => {
      const db = req.result;
