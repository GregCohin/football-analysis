...
function emptyCompetitionInstance(name, type) {
  return {
    id: newId(), name, type,
    fixtures: [], standings: [],
        ...
        <table className="stat-table">
          ...
          <tbody>
            {round.matches.map((m, i) => (
              <tr key={i}><td>{m.home}</td><td>{m.homeScore} - {m.awayScore}</td><td>{m.away}</td></tr>
            ))}
          </tbody>
        </table>
      </div>
...
function CompetitionsScreen() {
  ...
  function createCompetition() {
    ...
    const instance = emptyCompetitionInstance(newName.trim(), typeTab);
    setData((prev) => {
    ...
    <div className="stats-screen">
        ...
        <div style={{ marginTop: 16 }}>
          ...
          {!showNewForm ? (
            ...
            <div className="new-match-card" style={{ marginTop: 16 }}>
              ...
              <div className="form-actions">
                <button className="btn btn-ghost" onClick={() => { setShowNewForm(false); setNewName(""); }}>Annuler</button>
      ...
      {selected && (
        <div style={{ marginTop: 16 }}>
          ...
          <div className="panel-heading" style={{ marginTop: 10 }}>{selected.name}</div>
