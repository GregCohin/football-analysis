...
function emptyCompetitionInstance(name, type, groupName) {
  return {
    id: newId(), name, type, groupName: groupName || "",
    fixtures: [], standings: [],
...
function CompetitionsScreen() {
  ...
  function createCompetition() {
    ...
    const instance = emptyCompetitionInstance(newName.trim(), typeTab, newGroupName.trim());
    setData((prev) => {
        ...
        <div style={{ marginTop: 16 }}>
            ...
            {inType.map((c) => (
              <div className="roster-card" key={c.id} onClick={() => setSelectedId(c.id)} style={{ cursor: "pointer" }}>
                <div className="roster-card-info">
                  ...
                  <div className="roster-card-position">{c.fixtures.length} rencontre{c.fixtures.length > 1 ? "s" : ""}</div>
                </div>
                <div className="roster-card-actions">
          ...
          {!showNewForm ? (
            ...
            <div className="new-match-card" style={{ marginTop: 16 }}>
              ...
              <div className="form-actions">
                <button className="btn btn-ghost" onClick={() => { setShowNewForm(false); setNewName(""); setNewGroupName(""); }}>Annuler</button>
