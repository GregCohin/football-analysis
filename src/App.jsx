...
function MedicalScreen({ roster }) {
  ...
  useEffect(() => {
    ...
    try { setDisciplineRecords(JSON.parse(localStorage.getItem("tf_discipline_records") || "{}")); } catch (e) { setDisciplineRecords({}); }
    try {
      const idx = JSON.parse(localStorage.getItem("tf_matches_index") || "[]");
  ...
  const setDisciplineRecordsP = persist("tf_discipline_records", setDisciplineRecords);
  ...
  return (
    <div className="stats-screen">
      ...
      <div className="tabs">
        ...
        <button className={`tab ${subTab === "discipline" ? "active" : ""}`} onClick={() => setSubTab("discipline")}>Discipline</button>
      </div>
      ...
      {subTab === "discipline" && (
        <DisciplineScreen roster={roster} allFullMatches={allFullMatches} records={disciplineRecords} setRecords={setDisciplineRecordsP} />
      )}
    </div>
  );
}
