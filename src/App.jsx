...
function emptyExerciseForm() {
  return { name: "", objectif: "", duree: 15, nbJoueurs: "", materiel: "", description: "", gameplanSection: "", gameplanChoice: "", diagram: [], category: "tactique" };
}
...
function ExerciseBankScreen({ exercises, gameplan, specific, onAddToSession }) {
  ...
  grouped["_untagged"] = [];
  exercises.filter((ex) => (ex.category || "tactique") === "tactique").forEach((ex) => {
  ...
  const otherCategoryExercises = exercises.filter((ex) => ex.category === categoryFilter);
