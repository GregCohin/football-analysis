...
function TacticalPadEditor({ elements, setElements }) {
  ...
  return (
    <div>
      ...
      <p className="hint">Choisis un élément puis clique sur le terrain pour le placer. Pour les flèches et la zone, un clic par étape (coche "Courber" avant de commencer pour ajouter un point de courbure). "Flèche course" est en pointillés, "Flèche passe" en trait plein, "Flèche course + ballon" est ondulée.</p>
    </div>
  );
}
