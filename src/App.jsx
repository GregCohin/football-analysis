...
function ExerciseCreationScreen({ exercises, setExercises, gameplan }) {
  ...
  return (
    <div>
      {!showForm && <button className="btn btn-primary btn-large" onClick={openNew} style={{ marginBottom: 20 }}>+ Créer un exercice</button>}
...
function InjuriesScreen({ roster, injuries, setInjuries, programs }) {
  ...
  return (
    <div>
      ...
      {!showForm && <button className="btn btn-primary btn-large" onClick={openNew} style={{ margin: "16px 0" }}>+ Déclarer une blessure</button>}
...
function ProgramsScreen({ programs, setPrograms }) {
  ...
  return (
    <div>
      ...
      {!showForm && <button className="btn btn-primary btn-large" onClick={openNew} style={{ marginBottom: 20 }}>+ Créer un programme</button>}
