...
function PrintableSheetsTab({ causerie, updateCauserie }) {
  ...
  if (selectedSheet) {
    return (
      <div>
        ...
        <TacticalPadEditor elements={selectedSheet.elements} setElements={(v) => setSheetElements(selectedSheet.id, v)} />
      </div>
    );
  }
    ...
    <div className="stats-screen">
      ...
      {selected && (
        <div>
          ...
          {subTab === "fiches" && <PrintableSheetsTab causerie={selected} updateCauserie={updateCauserie} />}
        </div>
      )}
    </div>
  );
