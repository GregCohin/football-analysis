    ...
    <div className="stats-screen">
      ...
      {selected && (
        <div>
          ...
          <label className="no-print" style={{ display: "block", marginBottom: 16 }}>
            Notes pour la causerie (points clés à l'oral)
            <textarea rows={2} placeholder="ex. Insister sur l'agressivité sur les 2e ballons, féliciter le pressing du dernier match…" value={selected.notes || ""} onChange={(e) => updateCauserie({ ...selected, notes: e.target.value })} />
          </label>
